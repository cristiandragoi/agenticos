// Focus the Electron window, then run the color round-trip with pixel sampling.
...
const task = await j('/api/background-tasks', {
  ...
  body: JSON.stringify({ title: 'Focus roundtrip', objective: 'pink', worker: 'research', dispatch: false }),
});
let del = null;
